...
@section('title','Editar datos personales de '.$datos->nombre)
...
@section('datos-personales')
	...
	{!! Form::open(['route' => ['datos-personales.update',$datos], 'method' => 'PUT']) !!}

		<div class="container">

			<div class = "form-group">
				{!! Form::label('apellido_paterno','3.1.1 *Apellido Paterno') !!}
				{!! Form::text('apellido_paterno',$datos->apellido_paterno,['class' => 'form-control','placeholder' => 'Gutierrez' ,'required']) !!}
			</div>

			<div class = "form-group">
				{!! Form::label('apellido_materno','3.1.2 *Apellido Materno') !!}
				{!! Form::text('apellido_materno',$datos->apellido_materno,['class' => 'form-control','placeholder' => 'Hernandez' ,'required']) !!}
			</div>

			<div class = "form-group">
				{!! Form::label('nombre','3.1.3 *Nombre(s)') !!}
				{!! Form::text('nombre',$datos->nombre,['class' => 'form-control','placeholder' => 'Eduardo' ,'required']) !!}
			</div>
			...
			<div class = "form-group">
				...
				{!! Form::text('fecha_nacimiento',$datos->fecha_nacimiento,['class' => 'form-control','placeholder' => 'dd/mm/aaaa' ,'required']) !!}
			</div>

			<div class = "form-group">
				{!! Form::label('edad','3.4 *Edad') !!}
				{!! Form::text('edad',$datos->edad,['class' => 'form-control','placeholder' => '18' ,'required']) !!}
			</div>

			<div class = "form-group">
				{!! Form::label('rfc','3.5 *RFC') !!}
				{!! Form::text('rfc',$datos->rfc,['class' => 'form-control','placeholder' => '10 dígitos' ,'required']) !!}
			</div>
			...
			<div class = "form-group">
				...
				{!! Form::text('curp',$datos->curp,['class' => 'form-control','placeholder' => 'CURP' ,'required']) !!}
			</div>
			...
			<div class = "form-group">
				...
				{!! Form::text('folio',$datos->folio,['class' => 'form-control','placeholder' => '511039' ,'required']) !!}
			</div>

			<div class = "form-group">
				{!! Form::label('tel_fijo','3.10 *Teléfono fijo (con lada)') !!}
				{!! Form::text('tel_fijo',$datos->tel_fijo,['class' => 'form-control','placeholder' => '(722)2808118' ,'required']) !!}
			</div>

			<div class = "form-group">
				{!! Form::label('tel_celular','3.11 *Teléfono celular') !!}
				{!! Form::text('tel_celular',$datos->tel_celular,['class' => 'form-control','placeholder' => '7228848248' ,'required']) !!}
			</div>

			<div class = "form-group">
				{!! Form::label('correo','3.12 *Correo electrónico') !!}
				{!! Form::email('correo',$datos->correo,['class' => 'form-control','placeholder' => 'ejemplo@gmail.com' ,'required']) !!}
			</div>

			<div class = "form-group">
				{!! Form::label('ent_fed_nacimiento','3.13 *Entidad federativa de nacimiento') !!}
				{!! Form::text('ent_fed_nacimiento',$datos->ent_fed_nacimiento,['class' => 'form-control','placeholder' => 'México' ,'required']) !!}
			</div>
